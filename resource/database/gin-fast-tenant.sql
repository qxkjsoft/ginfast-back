/*
 ...
 Source Schema         : gin-fast-tenant

 Target Server Type    : MySQL
 Target Server Version : 50726
 File Encoding         : 65001

 Date: 09/11/2025 18:27:07
*/
...
CREATE TABLE `example`  (
  ...
  `tenant_id` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '租户ID字段',
...
CREATE TABLE `students`  (
  ...
  `student_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '姓名',
  `age` int(11) NOT NULL DEFAULT 18 COMMENT '年龄',
  `gender` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT '性别',
  `class_name` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '班级名称',
  `admission_date` datetime(0) NOT NULL COMMENT '入学日期',
  ...
  `tenant_id` int(11) UNSIGNED NULL DEFAULT NULL COMMENT '租户ID字段',
  PRIMARY KEY (`student_id`) USING BTREE,
  UNIQUE INDEX `email`(`email`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 13 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '学员管理' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of students
-- ----------------------------
INSERT INTO `students` VALUES (1, '张三', 18, '男', '计算机科学与技术1班', '2023-09-01 00:00:00', 'zhangsan@example.com', '13800138001', '北京市海淀区', NULL, NULL, NULL, 1, NULL);
INSERT INTO `students` VALUES (2, '李四', 19, '女', '计算机科学与技术1班', '2023-09-01 00:00:00', 'lisi@example.com', '13800138002', '北京市朝阳区', NULL, NULL, NULL, 1, NULL);
INSERT INTO `students` VALUES (3, '王五', 18, '男', '软件工程2班', '2023-09-01 00:00:00', 'wangwu@example.com', '13800138003', '上海市浦东新区', NULL, NULL, NULL, 1, NULL);
INSERT INTO `students` VALUES (4, '赵六', 17, '女', '软件工程2班', '2023-09-01 00:00:00', 'zhaoliu@example.com', '13800138004', '广州市天河区', NULL, NULL, NULL, 1, NULL);
INSERT INTO `students` VALUES (5, '孙七', 19, '男', '数据科学1班', '2023-09-01 00:00:00', 'sunqi@example.com', '13800138005', '深圳市南山区', NULL, NULL, NULL, 1, NULL);
INSERT INTO `students` VALUES (6, '2', 2, '2', '2', '2006-01-02 23:04:05', '2', '2', '2', '2025-11-06 14:57:46', '2025-11-07 15:11:22', NULL, 0, 0);
INSERT INTO `students` VALUES (7, '3', 3, '3', '3', '2025-11-06 08:00:00', '3', '3', '3', '2025-11-06 16:12:26', '2025-11-07 15:11:30', NULL, 0, 0);
INSERT INTO `students` VALUES (8, '55', 55, '55', '55', '2025-11-07 08:00:00', '55', '55', '55', '2025-11-06 16:27:07', '2025-11-06 16:27:21', '2025-11-06 16:27:29', NULL, NULL);
INSERT INTO `students` VALUES (9, '6', 6, '6', '6', '2025-11-06 08:00:00', '6', '6', '6', '2025-11-06 17:13:52', '2025-11-06 17:13:52', NULL, NULL, NULL);
INSERT INTO `students` VALUES (10, '7', 7, '7', '7', '2025-11-25 08:00:00', '7', '7', '7', '2025-11-06 17:16:22', '2025-11-06 17:16:22', NULL, 1, 0);
INSERT INTO `students` VALUES (11, '8', 8, '8', '8', '2025-11-07 08:00:00', '8', '8', '8', '2025-11-07 15:11:11', '2025-11-07 15:11:11', '2025-11-07 15:15:04', 1, 0);
INSERT INTO `students` VALUES (12, '9', 9, '9', '9', '2025-11-19 08:00:00', '9', '9', '9', '2025-11-07 15:14:43', '2025-11-07 15:14:43', NULL, 1, 0);
...
CREATE TABLE `sys_affix`  (
  ...
  `ftype` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '文件类型',
  `created_at` datetime(0) NULL DEFAULT NULL,
  `updated_at` datetime(0) NULL DEFAULT NULL,
  `deleted_at` datetime(0) NULL DEFAULT NULL,
  `created_by` int(11) NULL DEFAULT NULL,
  `suffix` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '文件后缀',
  `tenant_id` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '租户ID字段',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `sys_api`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '权限名称',
  `path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '权限路径',
  `method` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '请求方法',
  `api_group` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '分组',
  `created_at` datetime(0) NULL DEFAULT NULL,
  `updated_at` datetime(0) NULL DEFAULT NULL,
  `deleted_at` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `sys_casbin_rule`  (
  ...
  `ptype` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `v0` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `v1` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `v2` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `v3` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `v4` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `v5` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 4638 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_casbin_rule` VALUES (4625, 'p', 'role_1', '/api/codegen/columns', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4592, 'p', 'role_1', '/api/codegen/generate', 'POST', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4578, 'p', 'role_1', '/api/config/get', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4566, 'p', 'role_1', '/api/config/update', 'PUT', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4579, 'p', 'role_1', '/api/config/viewCache', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4630, 'p', 'role_1', '/api/plugins/example/*', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4616, 'p', 'role_1', '/api/plugins/example/add', 'POST', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4580, 'p', 'role_1', '/api/plugins/example/delete', 'DELETE', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4583, 'p', 'role_1', '/api/plugins/example/edit', 'PUT', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4591, 'p', 'role_1', '/api/plugins/example/list', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4576, 'p', 'role_1', '/api/sysAffix/delete', 'DELETE', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4577, 'p', 'role_1', '/api/sysAffix/download/*', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4614, 'p', 'role_1', '/api/sysAffix/list', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4615, 'p', 'role_1', '/api/sysAffix/updateName', 'PUT', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4570, 'p', 'role_1', '/api/sysAffix/upload', 'POST', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4633, 'p', 'role_1', '/api/sysApi/*', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4590, 'p', 'role_1', '/api/sysApi/add', 'POST', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4612, 'p', 'role_1', '/api/sysApi/delete', 'DELETE', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4575, 'p', 'role_1', '/api/sysApi/edit', 'PUT', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4587, 'p', 'role_1', '/api/sysApi/list', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4610, 'p', 'role_1', '/api/sysDepartment/add', 'POST', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4596, 'p', 'role_1', '/api/sysDepartment/delete', 'DELETE', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4602, 'p', 'role_1', '/api/sysDepartment/edit', 'PUT', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4564, 'p', 'role_1', '/api/sysDepartment/getDivision', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4613, 'p', 'role_1', '/api/sysDict/add', 'POST', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4623, 'p', 'role_1', '/api/sysDict/delete', 'DELETE', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4582, 'p', 'role_1', '/api/sysDict/edit', 'PUT', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4620, 'p', 'role_1', '/api/sysDict/getAllDicts', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4573, 'p', 'role_1', '/api/sysDict/list', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4636, 'p', 'role_1', '/api/sysDictItem/add', 'POST', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4627, 'p', 'role_1', '/api/sysDictItem/delete', 'DELETE', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4569, 'p', 'role_1', '/api/sysDictItem/edit', 'PUT', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4629, 'p', 'role_1', '/api/sysDictItem/getByDictId/*', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4574, 'p', 'role_1', '/api/sysMenu/add', 'POST', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4622, 'p', 'role_1', '/api/sysMenu/apis/*', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4632, 'p', 'role_1', '/api/sysMenu/delete', 'DELETE', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4601, 'p', 'role_1', '/api/sysMenu/edit', 'PUT', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4567, 'p', 'role_1', '/api/sysMenu/export', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4581, 'p', 'role_1', '/api/sysMenu/getMenuList', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4609, 'p', 'role_1', '/api/sysMenu/getRouters', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4635, 'p', 'role_1', '/api/sysMenu/import', 'POST', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4626, 'p', 'role_1', '/api/sysMenu/setApis', 'POST', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4603, 'p', 'role_1', '/api/sysOperationLog/delete', 'DELETE', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4624, 'p', 'role_1', '/api/sysOperationLog/export', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4586, 'p', 'role_1', '/api/sysOperationLog/list', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4595, 'p', 'role_1', '/api/sysRole/add', 'POST', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4600, 'p', 'role_1', '/api/sysRole/addRoleMenu', 'POST', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4571, 'p', 'role_1', '/api/sysRole/dataScope', 'PUT', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4605, 'p', 'role_1', '/api/sysRole/delete', 'DELETE', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4599, 'p', 'role_1', '/api/sysRole/edit', 'PUT', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4628, 'p', 'role_1', '/api/sysRole/getRoles', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4565, 'p', 'role_1', '/api/sysRole/getUserPermission/*', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4585, 'p', 'role_1', '/api/sysTenant/*', 'DELETE', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4617, 'p', 'role_1', '/api/sysTenant/*', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4606, 'p', 'role_1', '/api/sysTenant/add', 'POST', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4607, 'p', 'role_1', '/api/sysTenant/edit', 'PUT', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4597, 'p', 'role_1', '/api/sysTenant/list', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4611, 'p', 'role_1', '/api/sysUserTenant/batchAdd', 'POST', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4631, 'p', 'role_1', '/api/sysUserTenant/batchDelete', 'DELETE', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4618, 'p', 'role_1', '/api/sysUserTenant/get', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4619, 'p', 'role_1', '/api/sysUserTenant/getRolesAll', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4568, 'p', 'role_1', '/api/sysUserTenant/getUserRoleIDs', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4621, 'p', 'role_1', '/api/sysUserTenant/list', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4608, 'p', 'role_1', '/api/sysUserTenant/setUserRoles', 'POST', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4572, 'p', 'role_1', '/api/sysUserTenant/userListAll', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4563, 'p', 'role_1', '/api/users/*', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4604, 'p', 'role_1', '/api/users/add', 'POST', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4594, 'p', 'role_1', '/api/users/delete', 'DELETE', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4598, 'p', 'role_1', '/api/users/edit', 'PUT', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4593, 'p', 'role_1', '/api/users/list', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4588, 'p', 'role_1', '/api/users/logout', 'POST', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4634, 'p', 'role_1', '/api/users/profile', 'GET', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4584, 'p', 'role_1', '/api/users/updateAccount', 'PUT', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4637, 'p', 'role_1', '/api/users/updateBasicInfo', 'PUT', '*', '', '');
INSERT INTO `sys_casbin_rule` VALUES (4589, 'p', 'role_1', '/api/users/uploadAvatar', 'POST', '*', '', '');
...
CREATE TABLE `sys_department`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `parent_id` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '父级',
...
CREATE TABLE `sys_dict_item`  (
  ...
  `status` tinyint(1) NULL DEFAULT NULL COMMENT '状态',
  `dict_id` int(11) UNSIGNED NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `sys_gen`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '表名',
  `module_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '模块名称',
  `describe` varchar(1000) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '描述',
  `created_at` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
...
-- Records of sys_gen
-- ----------------------------
INSERT INTO `sys_gen` VALUES (8, 'students', 'students', '学员管理', '2025-11-09 18:24:26', '2025-11-09 18:24:26', NULL, 1);
...
CREATE TABLE `sys_gen_field`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `gen_id` int(11) UNSIGNED NULL DEFAULT NULL,
  `data_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '列名',
  `data_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '数据类型',
  `data_comment` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '列注释',
  `data_extra` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '额外信息',
  `is_primary` tinyint(3) NULL DEFAULT NULL COMMENT '是否主键',
  `go_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT 'go类型',
  `front_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '前端类型',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `sys_gen_field` VALUES (1, 8, 'student_id', 'int', '', 'auto_increment', 1, 'uint', 'number');
INSERT INTO `sys_gen_field` VALUES (2, 8, 'student_name', 'varchar', '姓名', '', 0, 'string', 'string');
INSERT INTO `sys_gen_field` VALUES (3, 8, 'age', 'int', '年龄', '', 0, 'int', 'number');
INSERT INTO `sys_gen_field` VALUES (4, 8, 'gender', 'varchar', '性别', '', 0, 'string', 'string');
INSERT INTO `sys_gen_field` VALUES (5, 8, 'class_name', 'varchar', '班级名称', '', 0, 'string', 'string');
INSERT INTO `sys_gen_field` VALUES (6, 8, 'admission_date', 'datetime', '入学日期', '', 0, 'time.Time', 'string');
INSERT INTO `sys_gen_field` VALUES (7, 8, 'email', 'varchar', ' 邮箱', '', 0, 'string', 'string');
INSERT INTO `sys_gen_field` VALUES (8, 8, 'phone', 'varchar', '电话号码', '', 0, 'string', 'string');
INSERT INTO `sys_gen_field` VALUES (9, 8, 'address', 'text', '地址', '', 0, 'string', 'string');
INSERT INTO `sys_gen_field` VALUES (10, 8, 'created_at', 'datetime', '创建时间', '', 0, 'time.Time', 'string');
INSERT INTO `sys_gen_field` VALUES (11, 8, 'updated_at', 'datetime', '更新时间', '', 0, 'time.Time', 'string');
INSERT INTO `sys_gen_field` VALUES (12, 8, 'deleted_at', 'datetime', '删除时间', '', 0, 'time.Time', 'string');
INSERT INTO `sys_gen_field` VALUES (13, 8, 'created_by', 'int', '创建人', '', 0, 'uint', 'number');
INSERT INTO `sys_gen_field` VALUES (14, 8, 'tenant_id', 'int', '租户ID字段', '', 0, 'uint', 'number');
...
CREATE TABLE `sys_menu`  (
  ...
  `parent_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0' COMMENT '父级路由ID，顶层为0',
  ...
  `component` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '组件文件路径',
  `title` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '菜单标题，国际化key',
  `is_full` tinyint(1) NULL DEFAULT 0 COMMENT '是否全屏显示：0-否，1-是',
  `hide` tinyint(1) NULL DEFAULT 0 COMMENT '是否隐藏：0-否，1-是',
  `disable` tinyint(1) NULL DEFAULT 0 COMMENT '是否停用：0-否，1-是',
  `keep_alive` tinyint(1) NULL DEFAULT 0 COMMENT '是否缓存：0-否，1-是',
  `affix` tinyint(1) NULL DEFAULT 0 COMMENT '是否固定：0-否，1-是',
  `link` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '外链地址',
  `iframe` tinyint(1) NULL DEFAULT 0 COMMENT '是否内嵌：0-否，1-是',
  `svg_icon` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT 'svg图标名称',
  `icon` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '普通图标名称',
  `sort` int(11) NULL DEFAULT 0 COMMENT '排序字段',
  `type` tinyint(1) NULL DEFAULT 2 COMMENT '类型：1-目录，2-菜单，3-按钮',
  `is_link` tinyint(1) NULL DEFAULT 0 COMMENT '是否外链',
  `permission` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '权限标识',
...
) ENGINE = InnoDB AUTO_INCREMENT = 140266 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统菜单路由表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_operation_logs`  (
  ...
  `path` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '请求路径',
...
) ENGINE = InnoDB AUTO_INCREMENT = 2216 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统操作日志表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_operation_logs` VALUES (2212, '2025-11-07 15:35:28.000', '2025-11-07 15:35:28.000', NULL, 1, 'admin', '菜单管理', 'query', 'GET', '/api/sysMenu/getMenuList', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Safari/537.36', '', '', 200, 51, '', '', 0);
INSERT INTO `sys_operation_logs` VALUES (2213, '2025-11-07 15:35:40.000', '2025-11-07 15:35:40.000', NULL, 1, 'admin', '角色管理', 'query', 'GET', '/api/sysRole/getUserPermission/1', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Safari/537.36', '', '', 200, 5, '', '', 0);
INSERT INTO `sys_operation_logs` VALUES (2214, '2025-11-07 15:35:45.000', '2025-11-07 15:35:45.000', NULL, 1, 'admin', '角色管理', 'create', 'POST', '/api/sysRole/addRoleMenu', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Safari/537.36', '{\"menuId\":[1,10,1001,1002,1003,1004,1005,1006,1007,140213,140214,140215,140216,140218,140219,140220,140221,140222,140223,140224,140225,140226,140227,140228,140229,140230,140231,140232,140233,140234,140235,140236,140237,140238,140239,140240,140241,140242,140243,140244,140245,140246,140247,140248,140249,140250,140251,140252,140254,140255,140256,140257,140258,140259,140260,140261,140262,140263,140264,140274,140275,140276,140265],\"roleId\":1}', '', 400, 8, '菜单ID不存在', '', 0);
INSERT INTO `sys_operation_logs` VALUES (2215, '2025-11-07 15:35:51.000', '2025-11-07 15:35:51.000', NULL, 1, 'admin', '角色管理', 'create', 'POST', '/api/sysRole/addRoleMenu', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Safari/537.36', '{\"menuId\":[1,10,1001,1002,1003,1004,1005,1006,1007,140213,140214,140215,140216,140218,140219,140220,140221,140222,140223,140224,140225,140226,140227,140228,140229,140230,140231,140232,140233,140234,140235,140236,140237,140238,140239,140240,140241,140242,140243,140244,140245,140246,140247,140248,140249,140250,140251,140252,140254,140255,140256,140257,140258,140259,140260,140261,140262,140263,140264,140274,140275,140276],\"roleId\":1}', '', 400, 7, '菜单ID不存在', '', 0);
...
CREATE TABLE `sys_role`  (
  ...
  `deleted_at` datetime(0) NULL DEFAULT NULL,
  `created_by` int(11) UNSIGNED NULL DEFAULT NULL,
  `data_scope` int(11) NULL DEFAULT 0 COMMENT '数据权限',
  `checked_depts` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '数据权限关联的部门',
  `tenant_id` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '租户ID字段',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `sys_tenants`  (
  ...
  `description` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '租户描述',
  `status` tinyint(4) NOT NULL DEFAULT 1 COMMENT '状态 0停用 1启用',
  `domain` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '租户域名',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `code`(`code`) USING BTREE,
  INDEX `idx_sys_tenants_deleted_at`(`deleted_at`) USING BTREE
...
CREATE TABLE `sys_user_tenant`  (
  ...
  `is_default` tinyint(1) NULL DEFAULT 0 COMMENT '是否默认租户',
  `created_at` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`user_id`, `tenant_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '用户及租户关联表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_users`  (
  ...
  `email` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '' COMMENT '邮箱',
  `status` tinyint(1) NULL DEFAULT 1 COMMENT '是否启用 0停用 1启用',
  `dept_id` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '部门ID',
  `phone` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '' COMMENT '电话',
  `sex` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '' COMMENT '性别',
  `nick_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '' COMMENT '昵称',
  `avatar` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '' COMMENT '头像',
  `description` varchar(500) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '描述',
  `created_at` datetime(0) NULL DEFAULT NULL,
  `updated_at` datetime(0) NULL DEFAULT NULL,
  `deleted_at` datetime(0) NULL DEFAULT NULL,
  `created_by` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '创建人',
  `tenant_id` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '租户ID字段',
  PRIMARY KEY (`id`) USING BTREE,
