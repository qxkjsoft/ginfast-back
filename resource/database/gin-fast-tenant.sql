...
) ENGINE = MyISAM AUTO_INCREMENT = 20 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '学员管理' ROW_FORMAT = Dynamic;
...
INSERT INTO `demo_students` VALUES (19, '444', 4, '1', '[\"b\"]', '2025-11-24 08:00:00', '', '', '1', '2025-11-15 16:36:01', '2025-11-15 16:36:11', NULL, 1, 0);
...
CREATE TABLE `demo_teacher`  (
  ...
  `employee_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '工号',
  `gender` tinyint(1) NULL DEFAULT 0 COMMENT '性别：0-未知 1-男 2-女',
  `phone` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '手机号',
  `email` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '邮箱',
  `subject` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '所教学科',
  `title` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '职称',
  `status` tinyint(1) NULL DEFAULT 1 COMMENT '状态：0-离职 1-在职',
...
INSERT INTO `sys_api` VALUES (182, '列表查询', '/api/plugins/testbook/testteacher/list', 'GET', '教师表', '2025-11-15 16:38:47', '2025-11-15 16:38:47', NULL, 1);
INSERT INTO `sys_api` VALUES (183, '新增', '/api/plugins/testbook/testteacher/add', 'POST', '教师表', '2025-11-15 16:38:47', '2025-11-15 16:38:47', NULL, 1);
INSERT INTO `sys_api` VALUES (184, '修改', '/api/plugins/testbook/testteacher/edit', 'PUT', '教师表', '2025-11-15 16:38:47', '2025-11-15 16:38:47', NULL, 1);
INSERT INTO `sys_api` VALUES (185, '删除', '/api/plugins/testbook/testteacher/delete', 'DELETE', '教师表', '2025-11-15 16:38:47', '2025-11-15 16:38:47', NULL, 1);
INSERT INTO `sys_api` VALUES (186, '查询单条数据', '/api/plugins/testbook/testteacher/:id', 'GET', '教师表', '2025-11-15 16:38:47', '2025-11-15 16:38:47', NULL, 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 5377 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_gen`  (
  ...
  `database` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '数据库',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '数据库表名',
  ...
  `deleted_at` datetime(0) NULL DEFAULT NULL COMMENT '删除时间',
  `created_by` int(11) UNSIGNED NULL DEFAULT NULL COMMENT '创建人',
  `is_cover` tinyint(3) NULL DEFAULT 0 COMMENT '是否覆盖',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of sys_gen
-- ----------------------------
INSERT INTO `sys_gen` VALUES (23, 'mysql', 'gin-fast-tenant', 'demo_students', 'test_book', 'test_students', '学员管理', '2025-11-13 15:17:27', '2025-11-16 18:25:00', NULL, 1, 1);
INSERT INTO `sys_gen` VALUES (24, 'mysql', 'gin-fast-tenant', 'demo_teacher', 'test_book', 'test_teacher', '教师表', '2025-11-13 15:17:27', '2025-11-15 17:12:31', NULL, 1, NULL);
INSERT INTO `sys_gen` VALUES (25, 'mysql', 'gin-fast-tenant', 'example', 'test_example', 'example', 'example', '2025-11-16 17:47:41', '2025-11-16 18:23:54', NULL, 1, 1);
...
CREATE TABLE `sys_gen_field`  (
  ...
  `data_column_key` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '列键信息',
  `data_unsigned` tinyint(3) NULL DEFAULT 0 COMMENT '是否为无符号类型',
  `is_primary` tinyint(3) NULL DEFAULT 0 COMMENT '是否主键',
  ...
  `custom_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '' COMMENT '自定义字段名称',
  `require` tinyint(3) NULL DEFAULT 0 COMMENT '是否必填',
  `list_show` tinyint(3) NULL DEFAULT 0 COMMENT '列表显示',
  `form_show` tinyint(3) NULL DEFAULT 0 COMMENT '表单显示',
  `query_show` tinyint(3) NULL DEFAULT 0 COMMENT '查询显示',
  `query_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '查询方式\r\nEQ  等于\r\nNE 不等于\r\nGT 大于\r\nGTE 大于等于\r\nLT 小于\r\nLTE 小于等于\r\nLIKE 包含\r\nBETWEEN 范围',
  `form_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '表单类型\r\ninput 文本框\r\ntextarea 文本域\r\nnumber 数字输入框\r\nselect 下拉框\r\nradio 单选框\r\ncheckbox 复选框\r\ndatetime 日期时间',
  `dict_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '关联的字典',
  `gorm_tag` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT 'gorm标签',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `sys_gen_field` VALUES (202, 24, 'gender', 'tinyint', '性别：0-未知 1-男 2-女', '', '', 0, 0, 'int', 'number', 'gender', 1, 1, 1, 1, 'EQ', 'select', 'gender', 'column:gender;default:0');
...
INSERT INTO `sys_gen_field` VALUES (207, 24, 'status', 'tinyint', '状态：0-离职 1-在职', '', '', 0, 0, 'int', 'number', 'status', 1, 1, 1, 1, '', 'select', 'status', 'column:status;default:1');
...
INSERT INTO `sys_gen_field` VALUES (209, 24, 'birth_date', 'date', '出生日期', '', '', 0, 0, 'time.Time', 'string', 'birth_date', 1, 1, 1, 1, '', 'select', 'testStart', 'column:birth_date');
...
INSERT INTO `sys_gen_field` VALUES (222, 25, 'id', 'int', '', 'auto_increment', 'PRI', 1, 1, 'uint', 'number', 'id', 1, 1, 1, 1, '', '', '', 'column:id;primaryKey;not null;autoIncrement');
INSERT INTO `sys_gen_field` VALUES (223, 25, 'name', 'varchar', '名称', '', '', 0, 0, 'string', 'string', 'name', 1, 1, 1, 1, '', '', '', 'column:name;not null');
INSERT INTO `sys_gen_field` VALUES (224, 25, 'description', 'varchar', '描述', '', '', 0, 0, 'string', 'string', 'description', 1, 1, 1, 1, '', '', '', 'column:description');
INSERT INTO `sys_gen_field` VALUES (225, 25, 'created_at', 'datetime', '', '', '', 0, 0, 'time.Time', 'string', 'created_at', NULL, NULL, NULL, NULL, '', '', '', 'column:created_at;not null');
INSERT INTO `sys_gen_field` VALUES (226, 25, 'updated_at', 'datetime', '', '', '', 0, 0, 'time.Time', 'string', 'updated_at', NULL, NULL, NULL, NULL, '', '', '', 'column:updated_at');
INSERT INTO `sys_gen_field` VALUES (227, 25, 'deleted_at', 'datetime', '', '', '', 0, 0, 'time.Time', 'string', 'deleted_at', NULL, NULL, NULL, NULL, '', '', '', 'column:deleted_at');
INSERT INTO `sys_gen_field` VALUES (228, 25, 'created_by', 'int', '', '', '', 0, 0, 'int', 'number', 'created_by', NULL, NULL, NULL, NULL, '', '', '', 'column:created_by');
INSERT INTO `sys_gen_field` VALUES (229, 25, 'tenant_id', 'int', '租户ID字段', '', '', 1, 0, 'uint', 'number', 'tenant_id', NULL, NULL, NULL, NULL, '', '', '', 'column:tenant_id;default:0');
...
) ENGINE = InnoDB AUTO_INCREMENT = 140329 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统菜单路由表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_menu` VALUES (140325, '0', '/plugins/testbook/testteacherlist', 'Pluginstestbooktestteacher', '', 'plugins/testbook/views/testteacherlist', '教师表', 0, 0, 0, 1, 0, '', 0, '', 'IconMenu', 0, 2, 0, '', '2025-11-15 16:38:47', '2025-11-15 16:38:47', NULL, 1);
INSERT INTO `sys_menu` VALUES (140326, '140325', '', '', '', '', '新增', 0, 0, 0, 1, 0, '', 0, '', '', 0, 3, 0, 'plugins:testbooktestteacher:add', '2025-11-15 16:38:47', '2025-11-15 16:38:47', NULL, 1);
INSERT INTO `sys_menu` VALUES (140327, '140325', '', '', '', '', '编辑', 0, 0, 0, 1, 0, '', 0, '', '', 0, 3, 0, 'plugins:testbooktestteacher:edit', '2025-11-15 16:38:47', '2025-11-15 16:38:47', NULL, 1);
INSERT INTO `sys_menu` VALUES (140328, '140325', '', '', '', '', '删除', 0, 0, 0, 1, 0, '', 0, '', '', 0, 3, 0, 'plugins:testbooktestteacher:delete', '2025-11-15 16:38:47', '2025-11-15 16:38:47', NULL, 1);
...
INSERT INTO `sys_menu_api` VALUES (140325, 182);
INSERT INTO `sys_menu_api` VALUES (140326, 183);
INSERT INTO `sys_menu_api` VALUES (140327, 184);
INSERT INTO `sys_menu_api` VALUES (140327, 186);
INSERT INTO `sys_menu_api` VALUES (140328, 185);
